...
class OrderTable {
	 ...
	 * 
	 * @param reverse
	 *            specifies if the heap is min/max heap
	 */
	...
	/**
	 * This method creates a new price if the prices is not present in the order
	 * table
	 * 
	 * @param price
	 *            to be added
	...
	/**
	 * This method returns the list of orders (ordered according to the
	 * timestamp) for a specific price
	 * 
	 * @param price
	 *            price of an order
